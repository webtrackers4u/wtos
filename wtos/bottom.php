...
<img src="<?php echo URL_WTOS ?>images/poweredBywebtrackers4u.png" alt=""   height="25"  style="margin:0 0 0 5px; border:none;"/></a> 
Copyright &copy; <?php echo $os->today('Y');?> www.webtrackers.co.in - All Rights Reserved.
<script>os.viewCalender('wtDateClass','<?php echo $os->dateFormatJs; ?>');</script>
