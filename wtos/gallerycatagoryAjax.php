  ...
  <td ><b>Status</b></td>  
    ...
    while($record=$os->mfa($rsRecords)) {
        ...
        ?>
							...
							<span  class="actionLink" ><a href="javascript:void(0)"  onclick="WT_gallerycatagoryGetById('<?php echo $record['galleryCatagoryId'];?>')" >Edit</a></span>  <?php } ?>  </td>
								
<td><?php echo $record['categoryName']?> </td>  
  <td> <?php if(isset($os->galleryCatagoryActive[$record['active']])) {
      echo  $os->galleryCatagoryActive[$record['active']];
  } ?></td> 
