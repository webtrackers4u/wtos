...
<div class="uk-padding-small">
    <form  action="<?php echo $editPageLink ?>" method="post"   enctype="multipart/form-data">
        <h3 class="uk-margin-small">
            ...
            <button type="button" class="uk-button uk-button-small uk-button-danger"  value="Back to List" onclick="javascript:window.location='<?php echo $listPageLink ?>';">Back to List</button>
            </div>
        </h3>
        <div uk-grid>
            <div class="uk-width-expand@m">
                <div class="uk-card uk-card-small uk-card-default uk-card-body uk-margin">
                    ...
                    <div class="uk-margin-small">
                        <input value="<?php if(isset($pageData['heading'])) {
                            echo $pageData['heading'];
                        } ?>" type="text" name="heading" class="uk-input uk-form-large" id="heading"/>
                    </div>
                    <div class="uk-margin-small">
                        Link Name
                        <input value="<?php if(isset($pageData['title'])) {
                            echo $pageData['title'];
                        } ?>" type="text" name="title" class="uk-input uk-form-small" onchange="setSeoId(this.value);" id="title" />
                    </div>
                    ...
                    <div class="uk-margin-small">
                        Pre Include
                        <input value="<?php if(isset($pageData['preInclude'])) {
                            echo $pageData['preInclude'];
                        } ?>" type="text" name="preInclude" class="uk-input uk-form-small"/>
                    ...
                    <div class="uk-margin-small">
                        ...
                        <textarea class="uk-textarea uk-form-small"  name="excerpt" id="excerpt"><?php if(isset($pageData['excerpt'])) {
                            echo stripslashes($pageData['excerpt']);
                        } ?></textarea>
                    </div>
                    <div class="uk-margin-small">
                        Description

                        <textarea class="uk-textarea uk-form-small"  name="content" id="description" style="min-height: 400px; width: 100%"><?php if(isset($pageData['content'])) {
                    ...
                    <div class="uk-margin-small">
                        Post Include
                        <input value="<?php if(isset($pageData['postInclude'])) {
                            echo $pageData['postInclude'];
                        } ?>"  type="text" name="postInclude" class="uk-input uk-form-small"/>
                    </div>
                ...
                <div class="uk-card uk-card-small uk-card-default uk-card-body uk-margin">
                    ...
                    <div class="uk-margin-small">
                        ...
                        <textarea class="uk-textarea uk-form-small" name="metaTitle" id="metaTitle"><?php if(isset($pageData['metaTitle'])) {
                            echo $pageData['metaTitle'];
                        } ?></textarea>
                    </div>
                    ...
                    <div class="uk-margin-small">
                        ...
                        <textarea class="uk-textarea uk-form-small" name="metaTag" id="metaTag"><?php if(isset($pageData['metaTag'])) {
                            echo $pageData['metaTag'];
                        } ?></textarea>
                    </div>
                    <div class="uk-margin-small">
                        Meta Description:

                        <textarea class="uk-input uk-form-small" name="metaDescription" id="metaDescription"><?php if(isset($pageData['metaDescription'])) {
                            echo $pageData['metaDescription'];
                        } ?></textarea>
                    </div>
                    ...
                    <div class="uk-margin-small">
                        Page Css
                        <textarea class="uk-textarea uk-form-small" name="pageCss" id="pageCss"><?php if(isset($pageData['pageCss'])) {
                            echo $pageData['pageCss'];
                        } ?></textarea>
                    </div>
                        ...
                        <tr>
                            <td>
                                ...
                                <input name="icon" id="icon"
                                       ...
                                       value="<?php if(isset($pageData['icon'])) {
                                           echo $pageData['icon'];
                                       }?>"/>
                            ...
                            <td class="p-s">
                                <a class="uk-button uk-button-small uk-button-default">
                                    <i id="icon_view" uk-icon="<?php if(@$pageData['icon']!="") {
                                        echo $pageData['icon'];
                                    } else {
                                        echo "bell";
                                    }?>"></i>
                        ...
                        <tr>
                            ...
                            <td class="p-s">
                                <select name="parentPage" id="parentPage" class="uk-select uk-form-small">
                                    ...
                                    <?php
                                    if(isset($pageData['parentPage'])) {
                                        $tmpVar= $pageData['parentPage'];
                                    }
...
?>
                        ...
                        <tr>
                            ...
                            <td class="p-s"><select name="langId" id="langId" class="uk-select uk-form-small" >
                                    ...
                                    <?php
if(isset($pageData['langId'])) {
    $tmpVar= $pageData['langId'];
}
...
?>
                        ...
                        <tr>
                            ...
                            <td class="p-s">
                                <select class="uk-select uk-form-small" name="template" id="template">
                                    <?php $os->onlyOption(Template::get_templates(), $pageData["template"])?>
                                </select>
                            </td>
                        <tr>
                        <tr>
                            ...
                            <td class="p-s">
                                <input value="<?php if(isset($pageData['externalLink'])) {
                                    echo $pageData['externalLink'];
                                } ?>" type="text" name="externalLink" class="uk-input uk-form-small"/>
                            </td>
                        <tr>
                        <tr>
                            <td class="uk-table-shrink uk-text-nowrap">Slug</td>
                            <td class="p-s">
                                <input value="<?php if(isset($pageData['seoId'])) {
                                    echo $pageData['seoId'];
                                } ?>"  type="text" name="seoId" class="uk-input uk-form-small"  id="seoId"/>
                            </td>
                        <tr>
                    </table>
                </div>
                    ...
                    <table class="uk-margin-small uk-width-1-1" style="border-collapse: collapse">
                        <tr>
                            <td class="p-right-m uk-table-shrink">
                                <input class="uk-checkbox" type="checkbox" name="loginRequired" id="loginRequired" value="1" <?php if(isset($pageData['loginRequired'])) {
                                    if($pageData['loginRequired']=='1') { ?> checked="checked" <?php }
                                    } ?>  />
                            </td>
                            <td>
                                Required Login
                        ...
                        <tr>
                            <td><input class="uk-checkbox" type="checkbox" name="onHead" id="onHead" value="1" <?php if(isset($pageData['onHead'])) {
                                if($pageData['onHead']=='1') { ?> checked="checked" <?php }
                                } ?>  /></td>
                            <td>Place on Head Menu</td>
                        </tr>
                        <tr>
                            <td><input class="uk-checkbox" type="checkbox" name="onBottom" value="1" <?php  if(isset($pageData['onBottom'])) {
                                if($pageData['onBottom']=='1') { ?> checked="checked" <?php }
                                } ?>></td>
                            <td>Place on Bottom Menu</td>
                        </tr>

                        <tr>
                            <td><input class="uk-checkbox" type="checkbox" name="openNewTab" value="1" <?php  if(isset($pageData['openNewTab'])) {
                                if($pageData['openNewTab']=='1') { ?> checked="checked" <?php }
                                } ?>  /></td>
                ...
                <div class="uk-card uk-card-small uk-card-default uk-card-body uk-margin">
                    ...
                    <div class="uk-margin-small">
                        <label for="image" style="background-image: url('<?php  echo @BASE_URL.@$pageData['image']; ?>')" class="uk-width-1-1 uk-height-medium uk-placeholder uk-flex uk-flex-middle uk-flex-center uk-background-cover">
                        ...
                        <input type="checkbox" name="showImage" value="1" <?php if(isset($pageData['showImage'])) {
                            if($pageData['showImage']=='1') { ?> checked="checked" <?php }
                            } ?>  />
        ...
        <input type="hidden" name="rowId" value="<?php if(isset($pageData[$primeryField])) {
            echo $pageData[$primeryField];
        } ?>" />
