...
<div class="uk-padding uk-padding-small">
    ...
    <div>
        <div class="uk-inline uk-margin-small-bottom">
            <input type="text" id="searchKey" class="uk-input uk-form-small"  value="<? echo $searchKey ?>" />
        ...
        <div class="uk-inline uk-margin-small-bottom">
            ...
            <a href="javascript:void(0)"  onclick="os.editRecord('<? echo $editPageLink?>0') " class="uk-button uk-button-secondary uk-button-small">Add New Record</a>
        </div>
    </div>
        ...
        <table class="uk-table uk-table-small uk-table-striped uk-table-responsive">
            ...
            while(  $record=$os->mfa($records )){
                ...
                <tr>
                    ...
                    <td title="Admin Type"> <? echo $os->val($os->adminType,$record['adminType']); ?> </td>
