...
if($os->get('WT_wtosfactoryListing')=='OK') {
    ...
    $formTitle_s=$andformTitleA['value'];
    $andformTitle=$andformTitleA['andField'];
...
<div class="pagingLinkCss"> <?php echo $resource['links']; ?> </div>
...
<td><?php echo $record['formTitle']?> </td>  
								...
								<td><span style="cursor:pointer;" class="editAjax" onclick="WT_wtosfactoryGetById('<?php echo $record['wtosfactoryId'];?>')">Edit</span>    </td>
				 </tr>
                          <?php
