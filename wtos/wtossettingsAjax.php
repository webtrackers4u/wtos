  ...
  <td ><b>Value</b></td>  
    ...
    while($record=$os->mfa($rsRecords)) {
        ...
        ?>
							...
							<span  class="actionLink" ><a href="javascript:void(0)"  onclick="WT_settingsGetById('<?php echo $record['settingsId'];?>')" >Edit</a></span>  <?php } ?>  </td>
...
<td><?php echo $record['keyword']?> </td>  
  <td><?php echo $record['value']?> </td>  
		...
		Wtos Expiry :<?php 	$expDate=$os->getSettings('Validate WtosDate');
