...
function quickEdit_v_four($options, $foreignIdValue, $functionId)
{
  ...
  <div id="<?php echo $ajaxDiv; ?>"> </div>
   ...
   function <?php echo $ajaxEditFunction ?>()
   {
	...
	var url='quickEditPageAjx.php?foreignIdValue='+<?php echo $options['foreignIdGlobalKey'] ?>+'&aQEsessonKey=<?php echo $sessionKey ?>&getQuickEditValues=OK'+vars;
   ...
   function <?php echo $ajaxViewFunction ?>(foreignId)
   {
	...
	var url='quickEditPageAjx.php?foreignIdValue='+<?php echo $options['foreignIdGlobalKey'] ?>+'&aQEsessonKey=<?php echo $sessionKey ?>&getQuickViewValues=OK';
   ...
   function <?php echo $ajaxDeleteFunction ?>(tableId)
   {
	 ...
	 {
	var url='quickEditPageAjx.php?foreignIdValue='+<?php echo $options['foreignIdGlobalKey'] ?>+'&tableId='+tableId+'&aQEsessonKey=<?php echo $sessionKey ?>&getQuickDeleteValues=OK';
